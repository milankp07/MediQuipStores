...
class Interceptor extends \Magento\Tax\Block\Adminhtml\Rule\Edit\Form implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTaxRatesSelectConfig');
        return $pluginInfo ? $this->___callPlugins('getTaxRatesSelectConfig', func_get_args(), $pluginInfo) : parent::getTaxRatesSelectConfig($formValues);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTaxClassSelectConfig');
        return $pluginInfo ? $this->___callPlugins('getTaxClassSelectConfig', func_get_args(), $pluginInfo) : parent::getTaxClassSelectConfig($classType);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTaxRateDeleteUrl');
        return $pluginInfo ? $this->___callPlugins('getTaxRateDeleteUrl', func_get_args(), $pluginInfo) : parent::getTaxRateDeleteUrl();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTaxRateSaveUrl');
        return $pluginInfo ? $this->___callPlugins('getTaxRateSaveUrl', func_get_args(), $pluginInfo) : parent::getTaxRateSaveUrl();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTaxRateLoadUrl');
        return $pluginInfo ? $this->___callPlugins('getTaxRateLoadUrl', func_get_args(), $pluginInfo) : parent::getTaxRateLoadUrl();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTaxRatesPageUrl');
        return $pluginInfo ? $this->___callPlugins('getTaxRatesPageUrl', func_get_args(), $pluginInfo) : parent::getTaxRatesPageUrl();
    }
